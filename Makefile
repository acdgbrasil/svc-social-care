...
.PHONY: check-harness help run deps build build-release dev test regression coverage coverage-report ci clean
...
coverage: ## Executa testes + piso local de cobertura (25%)
