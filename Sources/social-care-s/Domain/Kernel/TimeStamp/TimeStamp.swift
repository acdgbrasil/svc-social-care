...
/// Value Object que representa um ponto específico no tempo (Timestamp).
///
...
///
/// Este objeto é fundamental para garantir a integridade temporal em todo o domínio,
/// desde o registro de nascimentos até a expiração de medidas protetivas.
